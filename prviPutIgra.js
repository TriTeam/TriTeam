...
const stavkeTutoriala=[
  1,
  {text:'Here you can change the speed you want to go, your speed will depand on your selected settings for each discipline.',id:'samoGas',next:'samoGas',pad:'10dvh'},
  {text:'This is your energy,the higher your speed is, the more energy you will spend',id:'energija',next:'energija',pad:'50dvh'},
  {text:'this is game field, here you will see your rivals, yoursels and percentage of race distance done 1-100%',id:'utrka',next:'utrka',pad:'90dvh'},
  {text:'here are can leave game after you finish the race, make sure that you will lose points if you leave before finish',id:'izadi',next:'izadi',pad:'40dvh'}
]
