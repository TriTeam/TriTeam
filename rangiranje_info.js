...
back.addEventListener('click', function(){tabla.style.display='none';})
info.addEventListener('click', function(){tabla.style.display='block';})
...
async function statusic(id) {
  ...
  if(vrijednostR<300){
    const sirina=(100-(vrijednostR/3))+'%';
    linijaa.style.width=sirina;
  }else if(vrijednostR<700){
    const sirina=(100-(vrijednostR-300)/4)+'%';
    linijaa.style.width=sirina;
  }else if(vrijednostR<1200){
    const sirina=(100-(vrijednostR-700)/5)+'%';
    linijaa.style.width=sirina;
  }else if(vrijednostR<1900){
    const sirina=(100-(vrijednostR-1200)/7)+'%';
    linijaa.style.width=sirina;
  }else{
...
back_join.addEventListener('click', function(){tabla_join.style.display='none';})
zaJoinTablu.addEventListener('click', function(){tabla_join.style.display='block';})



prijateljiBack.addEventListener('click', function(){prijateljiTabla.style.display='none';})
prijatelji.addEventListener('click', function(){prijateljiTabla.style.display='block';})


pravila.addEventListener('click', function(){pravilaDiv.style.display='block';})
pravilaBack.addEventListener('click', function(){pravilaDiv.style.display='none';})
