...
const stavkeTutoriala=[
  1,
  {text:'Here you can add your friends to your game',id:'kucicaPrazna2',next:'prijateljiBack',pad:'70dvh',tabla:'prijateljiTabla'},
  {text:'Here you will pick your color, and your settings for the race',id:'postavkeDiv',next:'postavkeDiv',pad:'50dvh',tabla:''},
  {text:'this is your game id, if you have not added your friends in menu, you can give them game id so they can join your game',id:'gameID',next:'gameID',pad:'40dvh',tabla:''},
  {text:'when there are 2-4 players in your loby ready button will turn green and you will be able to start a game',id:'ready',next:'ready',pad:'40dvh',tabla:''}
]
...
async function provjeraPrviPut(id) {
  ...
  let novo;
  if(snapshot.val().loby==0 || snapshot.val().tutorial==true){
