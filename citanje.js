    ...
    onValue(utrke, (snapshot) => {
        ...
        for (let i = 0; i < rezultat.length; i++){
            if(imeutrke==rezultat[i][0]){
                ...
                console.log(listica.length==0,listica, tokajideubazu)
        ...
        poljepojedinca.addEventListener('click',function(){
            ...
            if(tokajideubazu.length<4){
                if(odabirpojedinca==1){
                    idegas('natjecatelj1',poljepojedinca,ime,'slika1',poljeslike.innerHTML)
                }else if(odabirpojedinca==2){
                    idegas('natjecatelj2',poljepojedinca,ime,'slika2',poljeslike.innerHTML)
                }else if(odabirpojedinca==3){
                    idegas('natjecatelj3',poljepojedinca,ime,'slika3',poljeslike.innerHTML)
                }else if(odabirpojedinca==4){
                    idegas('natjecatelj4',poljepojedinca,ime,'slika4',poljeslike.innerHTML)
        }
            }else if(tokajideubazu.length>=4){
                if(odabirpojedinca==1){
                    idegas2('natjecatelj1',poljepojedinca,ime,'slika1',poljeslike.innerHTML)
                }else if(odabirpojedinca==2){
                    idegas2('natjecatelj2',poljepojedinca,ime,'slika2',poljeslike.innerHTML)
                }else if(odabirpojedinca==3){
                    idegas2('natjecatelj3',poljepojedinca,ime,'slika3',poljeslike.innerHTML)
                }else if(odabirpojedinca==4){
                    idegas2('natjecatelj4',poljepojedinca,ime,'slika4',poljeslike.innerHTML)
        }
            }
            
            })}};
let novci=100;
function idegas(natjec,poljepojedinca,ime,slikica,poljeslike){
        let popis=document.getElementById('popisNatjecatelja')
...
function idegas2(natjec, poljepojedinca, ime,slikica,poljeslike) {
